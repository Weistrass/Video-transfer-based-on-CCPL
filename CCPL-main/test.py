...
import net 
from function import nor_mean_std, nor_mean, coral
...
parser.add_argument('--decoder', type=str, default='author_artistic/decoder_iter_160000.pth.tar',help='put the trained decoder here')
parser.add_argument('--SCT', type=str, default='author_artistic/sct_iter_160000.pth.tar', help='put the trained SCT module here')
...
SCT.load_state_dict(torch.load(args.SCT),strict=False)
