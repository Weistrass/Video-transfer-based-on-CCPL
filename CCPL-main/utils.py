...
def makeVideo(content,style,props,outf):
    ...
    video = cv2.VideoWriter(os.path.join(outf,'me_grass_art.mp4'),fourcc,24,(width,height))
    ori_video = cv2.VideoWriter(os.path.join(outf, 'me_grass_art_content.mp4'), fourcc, 24, (width, height))
